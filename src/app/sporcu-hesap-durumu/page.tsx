...
import { ATHLETE_ACCOUNT_DISABLED_MESSAGE } from "@/lib/athlete/lifecycle";
import SporcuHesapLogoutButton from "./SporcuHesapLogoutButton";

export default async function SporcuHesapDurumuPage() {
  ...
  if (getSafeRole(profile.role) !== "sporcu") {
    redirect("/");
  }
